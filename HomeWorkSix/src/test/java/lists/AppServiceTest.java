...
class AppServiceTest {
     ...
     * в случае когда не происходит округление среднего значения при его нахождении (SumNumbersOfList/list.size() == 0)
     */
    @Test
     ...
     * Тест метода findTheAverageOfAList(List) для не пустого списка.
     * Тест для случая, когда среднее значение в диапазоне от (-бесконечности до бесконечности).
     * в случае когда происходит округление среднего значения при его нахождении (SumNumbersOfList/list.size() != 0)
     */
    @Test
